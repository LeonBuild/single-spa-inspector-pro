...
import { getRelayPort, getCdpUrl, getRelayToken, log, error, sleep, } from './utils.js';
let browser = null;
let currentTab = null;
    ...
    try {
        ...
        switch (name) {
            ...
            case 'accessibility_snapshot': {
                const accessibilitySnapshot = tab.page.accessibilitySnapshot;
            ...
            case 'execute': {
                ...
                const result = await tab.page.evaluate((codeStr) => {
                    try {
                        return eval(codeStr);
                    }
                    catch (e) {
